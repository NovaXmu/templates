  ...
  <div class="rich_media">
    <div class="rich_media_inner">
      <div class="rich_media_area_primary">
        <header>
          <h1 class="rich_media_title text-center">厦门大学校园微信日排行榜</h1>
        </header>
          ...
          <div>
            <form  class="text-center">
              <div class="form-group half">
                ...
                <input type="date" class="form-control" max="{$yesterday}" id="datepicker">
              </div>
              <div class="form-group half">
            ...
            <form  class="text-center">
              <div class="form-group">
                <input type="button" name="rank_day" class="btn btn-primary" id="ranks" value="查排行">
              </div>
              <div class="form-group">
                <input type="button" name="rank_day" class="btn btn-primary" id="articles" value="查热文">
              </div>
            </form><br/>
          </div>
